<?php	
	...
	$serverNames = array("EUW", "NA", "LAN", "OCE");
 	...
 	$ok = '<img src="https://www.publicdomainpictures.net/pictures/310000/velka/orange-circle.png" width="20px" height="20px">';
 	$offline = '<img src="https://upload.wikimedia.org/wikipedia/commons/9/9e/WX_circle_red.png" width="20px" height="20px">';
