<?php	
	...
	$serverNames = array("EUW", "NA", "LAN", "OCE");
 	$perfect = '<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Ski_trail_rating_symbol-green_circle.svg/240px-Ski_trail_rating_symbol-green_circle.svg.png" title="0 issues" width="20px" height="20px">';
 	$ok = '<img src="https://www.publicdomainpictures.net/pictures/310000/velka/orange-circle.png" title="Atleast 1 issue" width="20px" height="20px">';
 	$offline = '<img src="https://upload.wikimedia.org/wikipedia/commons/9/9e/WX_circle_red.png" title="Server OFFLINE" width="20px" height="20px">';
