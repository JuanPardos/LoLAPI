<?php
$server = array("euw1", "na1", "la1", "oc1", "kr");

$serverNames = array("EUW", "NA", "LAN", "OCE", "KR");
...
$status5 = fopen("https://kr.api.riotgames.com/lol/status/v3/shard-data?api_key=$apikey", "r");
...
$json_status5 = stream_get_contents($status5);
...
$data_status5 = json_decode($json_status5, true);
...
$online5 = array_column($data_status5['services'], 'status')['0'];
$incidents5 = array_column($data_status5['services'], 'incidents')['0'];

$auxon = array($online1, $online2, $online3, $online4, $online5);
$auxst = array($incidents1, $incidents2, $incidents3, $incidents4, $incidents5);
